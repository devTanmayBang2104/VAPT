      ...
      <Card className="bg-slate-800/50 border-emerald-500/30">
        <CardHeader>
          <CardTitle className="flex items-center gap-2 text-emerald-400">
            ...
            Automated Subdomain Enumeration ({enhancedSubdomains.length} Discovered)
          </CardTitle>
          ...
          <div className="mt-4 p-3 bg-emerald-900/30 rounded border border-emerald-600/30">
            <div className="flex items-center justify-between">
              <p className="text-xs text-emerald-300">
                🔍 Standard Analysis: {enhancedSubdomains.length} subdomains discovered using automated enumeration
              </p>
      ...
      <Card className="bg-slate-800/50 border-purple-500/30">
        <CardHeader>
          <CardTitle className="flex items-center gap-2 text-purple-400">
            ...
            Automated Port Scanning & Service Detection
          </CardTitle>
          <div className="flex flex-wrap gap-2">
            <Badge variant="outline" className="text-purple-400 border-purple-500/50">
              Service Detection
        ...
        <CardContent>
          ...
          <div className="mt-4 p-3 bg-purple-900/20 rounded border border-purple-600/30">
            <p className="text-xs text-purple-300">
              🎯 Standard Port Scan: {advancedPortScan.length} services identified with version detection and banner grabbing
            </p>
          </div>
        </CardContent>
      </Card>
